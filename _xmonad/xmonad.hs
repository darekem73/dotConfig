...
tall   = renamed [Replace "tall"]      $ minimize $ maximize $ spacing 3 $ ResizableTall 1 (3/100) (1/2) []
...
ndock  = renamed [Replace "ndock"]     $ minimize $ maximize $ spacing 3 $ NewDock 1 (3/100) (1/2)
pdock  = renamed [Replace "pdock"]      $ minimize $ maximize $ spacing 3 $ TwoPanePersistent Nothing (3/100) (1/2)
full   = renamed [Replace "full"]      $ minimize $ noBorders $ Full
stack  = renamed [Replace "stack"]     $ minimize $ maximize $ spacing 3 $ StackTile 1 (3/100) (1/2)
acc    = renamed [Replace "accordion"] $ minimize $ maximize $ spacing 3 $ Accordion
three  = renamed [Replace "three"]     $ minimize $ maximize $ spacing 3 $ ThreeColMid 1 (3/100) (1/2)
grid   = renamed [Replace "grid"]      $ minimize $ maximize $ spacing 3 $ Grid
autom  = renamed [Replace "auto"]      $ minimize $ maximize $ spacing 3 $ Mirror $ autoMaster 1 (1/100) Grid
